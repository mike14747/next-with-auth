...
export function formatDateObject(dateObj, type = 'short') {
...
export function formatDateObjectWithTime(dateTimeObj, type = 'short') {
...
export function formatDateString(dateStr, type = 'short') {
