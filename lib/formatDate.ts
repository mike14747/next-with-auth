...
export function formatDateObjectWithTime(dateTimeObj: Date, type: string = 'short'): string | null {
...
export function formatDateString(dateStr: string, type: string = 'short'): string | null {
